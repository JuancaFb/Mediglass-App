...
@Entity
@Table(name="falbacoml")
public class AlbaranesCompraL implements Serializable {

    public AlbaranesCompraL() {
    ...
    @Getter @Setter @Column(name="fealbadol")
    private String fealbadol;
